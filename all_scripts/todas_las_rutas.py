...
def definicion_rutas_por_estrella(estrella):
    ...
    rutas_array = {'route':route + ruta_estrella,'imagenes_cortadas':ruta_estrella+"imagenes_cortadas/",'archivo_catalogo':ruta_estrella+"datos_astrometria_modificados/datos_gaia3edr.csv" ,
